...
const Register = () => {
    ...
    const handleSubmit = (event) => {
        ...
        .then(res => {
            form.reset()
            toast.success("Your Account is successfully register! 💕")
            setUser(res.user)
    ...
    return (
      ...
      <div className="flex justify-center items-center bg-base-100">
        <div className="bg-white p-10 shadow-md w-[500px] rounded-xl mt-20">
          <h3 className="text-4xl mt-5 text-center font-bold">Register Now!</h3>
          <p className="text-center mb-8 mt-3.5">
